...
CREATE TABLE `timetable` (
  ...
  `tue` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `wed` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `thu` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `fri` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `sat` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `sun` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
